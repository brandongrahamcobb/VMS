/* app/src/plugin/handler_plugin.rs
 * The purpose of this module is to provide a plugin recruiting packet handler systems.
 *
    ...
    fn build(&self, app: &mut App) {
        app.add_systems(
            ...
            (
                ...
                handler::player_map_transfer::handle_player_map_transfer_request,
                handler::player_map_transfer::handle_player_map_transfer_response,
