...
use crate::message::packet::select_char_with_pic::ReadSelectCharWithPicMessage;
use crate::system::packet::dispatch::error::DispatchError;

pub fn read_select_char_with_pic_packet(
    packet: &Packet,
    client_id: i32,
) -> Result<ReadSelectCharWithPicMessage, DispatchError> {
    ...
    Ok(ReadSelectCharWithPicMessage {
        client_id,
        char_id,
        mac,
        hwid,
