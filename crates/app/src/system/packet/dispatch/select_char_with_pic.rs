/* app/src/system/dispatch/select_char_with_pic.rs
 * The purpose of this module is to read an incoming, pic-enabled, character selection packet.
 *
...
pub fn read_select_char_with_pic_packet(
    packet: &Packet,
    client_id: i32,
) -> Result<ReadSelectCharWithPicRequestMessage, DispatchError> {
    ...
    Ok(ReadSelectCharWithPicRequestMessage {
        client_id,
        char_id,
        mac,
        hwid,
