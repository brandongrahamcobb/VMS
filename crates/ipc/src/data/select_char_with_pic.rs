...
pub struct SelectCharWithPicEvent {
    pub char_id: i32,
    pub octets: [u8; 4],
    pub pic_status: bool,
    pub port: i16,
...
pub struct SelectCharWithPicCommand {
    pub client_id: i32,
    pub acc_id: i32,
    pub char_id: i32,
    pub mac: String,
...
impl SelectCharWithPicEvent {
    pub async fn store_select_char_with_pic(
        ...
        let pic_status = entity::account::service::check_pic(acc.model.pic, reader.pic.clone());
        Ok(Self {
