...
#[derive(Debug, Error)]
pub enum MapEntityError {
    #[error("Portal entity error map entity layer")]
    PortalEntityError(#[from] PortalEntityError),

    #[error("Parse int error in map entity layer")]
    ParseIntError(#[from] ParseIntError),

    #[error("No life map in metadata in map entity layer")]
    NoLife,
    // #[error("Mob respawn handler error in map entity layer")]
